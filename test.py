...
# Case 3
mergedTracks = pd.merge(tracksInput, tracksOutputTHB, on='TrackId', suffixes=('_input', '_output'))
if (mergedTracks['UnitPrice_output'] >= 33.77).all():
    f.write("Case 3: Pass\n")
else:
    f.write("Case 3: Fail\n")
